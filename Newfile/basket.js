var userCart = JSON.parse(localStorage.getItem("basketItem")) || [] 



// userCart.reduce(function(sum,element){
//     return sum + Number(element.Price)
// },0)
console.log(cartMrpTotal)
...
function removeFromCart(element,index){
  ...
  localStorage.setItem("basketItem",JSON.stringify(userCart))
